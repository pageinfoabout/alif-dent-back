      ...
      <div className="modal revenue-modal" onClick={e => e.stopPropagation()}>
        ...
        <div className="revenue-analytics-content">
            ...
            <section className="analytics-section">
              ...
              <div className="metrics-grid">
                ...
                <div className="metric-card">
                  ...
                  <div className="metric-value-small" style={{ color: '#0a7f2e' }}>Активен</div>
                </div>
              </div>
            </section>
          )}
          ...
          <section className="analytics-section">
            ...
            <div className="metrics-grid">
              <div className="metric-card">
                <div className="metric-label">Общая сумма заказов с купоном</div>
                <div className="metric-value">{rub(metrics.totalRevenueWithCoupon)}</div>
              </div>
              <div className="metric-card">
                <div className="metric-label">Количество заказов с купоном</div>
              ...
              <div className="metric-card">
                <div className="metric-label">Средний чек с купоном</div>
